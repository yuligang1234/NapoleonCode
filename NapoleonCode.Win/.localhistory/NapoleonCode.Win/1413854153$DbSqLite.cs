...
namespace NapoleonCode.Win
{
    public partial class DbSqLite : BaseForm
    {
        ...
        {
            //清除选中状态
            RadBaseModel.Checked = RadBaseField.Checked = RadBaseModel.Checked = RadBaseProcedure.Checked = RadNhMapping.Checked = RadNhModel.Checked = RadNhXml.Checked = false;
