...
{
    public partial class StartMsSqlForm : BaseForm
    {

        public StartMsSqlForm()
        {
            ApplySkin("McSkin");
            InitializeComponent();
            //读取配置
        ...
        private void DropDataBase_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "MSSQL"://MSSQL数据库
                    LblBrowse.Visible = LblPassWord.Visible = LblUserName.Visible = TxtBrowse.Visible = TxtPassWord.Visible = TxtUserName.Visible = true;
                    LblDbUrl.Visible = TxtDbUrl.Visible = BtnBrowser.Visible = false;
                    break;
                case "SQLite"://SQLite数据库
                    LblBrowse.Visible = LblPassWord.Visible = LblUserName.Visible = TxtBrowse.Visible = TxtPassWord.Visible = TxtUserName.Visible = false;
                    LblDbUrl.Visible = TxtDbUrl.Visible = BtnBrowser.Visible = true;
                    break;
            }
        }
